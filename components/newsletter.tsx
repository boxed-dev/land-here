              ...
              <svg width="428" height="328" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <radialGradient cx="35.542%" cy="34.553%" fx="35.542%" fy="34.553%" r="96.031%" id="ni-a">
                    ...
                    <stop stopColor="#FF8C00" offset="44.317%" />
...
<div className="text-center lg:text-left lg:max-w-xl">
  <h3 className="h3 text-white mb-2">Stay In the Loop with BizAI!</h3>
  <p className="text-gray-300 text-lg mb-6">Unlock the latest data insights, AI tips, and business intelligence with our newsletter. Join our community today.</p>
  ...
  <form className="w-full lg:w-auto">
    <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
      ...
      <a className="btn text-white bg-orange-600 hover:bg-orange-700 shadow" href="#0">Subscribe Now</a>
    </div>
    {/* Success message */}
