...
<div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
  <h2 className="h2 mb-4">Unleash the Power of BizAI</h2>
  <p className="text-xl text-gray-600">Discover a world of possibilities with BizAI - your personal data assistant that never sleeps.</p>
</div>
...
<div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
  ...
  <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
    ...
    <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">File Upload Compatibility</h4>
    <p className="text-gray-600 text-center">Seamlessly integrate data from various sources with support for XLSX, CSV, and more.</p>
  </div>
  ...
  <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
    ...
    <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Natural Language Queries</h4>
    <p className="text-gray-600 text-center">Ask questions about your data in plain English or any language without complex query languages.</p>
  </div>
  ...
  <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
    ...
    <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Advanced Data Analysis</h4>
    <p className="text-gray-600 text-center">Effortlessly perform intensive calculations and data analysis with BizAI.</p>
  </div>
  ...
  <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
    ...
    <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Cutting-Edge AI Technology</h4>
    <p className="text-gray-600 text-center">Experience the future with our state-of-the-art AI agents that deliver accurate responses.</p>
  </div>
  ...
  <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
    ...
    <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Effortless Data Exploration</h4>
    <p className="text-gray-600 text-center">Explore and extract insights from large datasets with just a simple click.</p>
  </div>
  ...
  <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
    ...
    <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Instant Query Responses</h4>
    <p className="text-gray-600 text-center">Receive real-time responses to your data-related queries, saving you time and effort.</p>
  </div>
</div>
</div>
</div>
