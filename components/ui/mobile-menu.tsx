  ...
  <div ref={mobileNav}>
    ...
    >
      <ul className="px-5 py-2">
        ...
        <li>
          <Link href="" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center">About</Link>
        </li>
        <li>
          <Link href="" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center">Pricing</Link>
        </li>
      </ul>          
    </Transition>
  </div>
